...
// HuggingFaceProxyRepositoryAPIRequest hugging face proxy repository Api request
//
// swagger:model HuggingFaceProxyRepositoryApiRequest
...
// Validate validates this hugging face proxy repository Api request
func (m *HuggingFaceProxyRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateHTTPClient(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateNegativeCache(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateProxy(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateReplication(formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
// ContextValidate validate this hugging face proxy repository Api request based on the context it is used
func (m *HuggingFaceProxyRepositoryAPIRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateHTTPClient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateNegativeCache(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateProxy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateReplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HuggingFaceProxyRepositoryAPIRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HuggingFaceProxyRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res HuggingFaceProxyRepositoryAPIRequest
