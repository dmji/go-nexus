...
const (
	...
	// HTTPClientConnectionAuthenticationAttributesWithPreemptiveTypeBearerToken captures enum value "bearerToken"
	HTTPClientConnectionAuthenticationAttributesWithPreemptiveTypeBearerToken string = "bearerToken"
)
