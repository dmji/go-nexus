...
func (m *PypiProxyRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePypi(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PypiProxyRepositoryAPIRequest) validatePypi(formats strfmt.Registry) error {
	if swag.IsZero(m.Pypi) { // not required
		return nil
	}

	if m.Pypi != nil {
		if err := m.Pypi.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("pypi")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("pypi")
			}
			return err
		}
	}
...
func (m *PypiProxyRepositoryAPIRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePypi(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PypiProxyRepositoryAPIRequest) contextValidatePypi(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.Pypi != nil {
		...
		if err := m.Pypi.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("pypi")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("pypi")
