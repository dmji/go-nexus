...
func (m *ConanProxyRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateConanProxy(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ConanProxyRepositoryAPIRequest) validateConanProxy(formats strfmt.Registry) error {
	if swag.IsZero(m.ConanProxy) { // not required
		return nil
	}

	if m.ConanProxy != nil {
		if err := m.ConanProxy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("conanProxy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("conanProxy")
			}
			return err
		}
	}
...
func (m *ConanProxyRepositoryAPIRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateConanProxy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ConanProxyRepositoryAPIRequest) contextValidateConanProxy(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ConanProxy != nil {
		...
		if err := m.ConanProxy.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("conanProxy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("conanProxy")
