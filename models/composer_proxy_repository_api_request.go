...
// ComposerProxyRepositoryAPIRequest composer proxy repository Api request
//
// swagger:model ComposerProxyRepositoryApiRequest
...
// Validate validates this composer proxy repository Api request
func (m *ComposerProxyRepositoryAPIRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ComposerProxyRepositoryAPIRequest) validateCleanup(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateHTTPClient(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateName(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateNegativeCache(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateOnline(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateProxy(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateReplication(formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) validateStorage(formats strfmt.Registry) error {
...
// ContextValidate validate this composer proxy repository Api request based on the context it is used
func (m *ComposerProxyRepositoryAPIRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateCleanup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateHTTPClient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateNegativeCache(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateProxy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateReplication(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) contextValidateStorage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ComposerProxyRepositoryAPIRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ComposerProxyRepositoryAPIRequest) UnmarshalBinary(b []byte) error {
	var res ComposerProxyRepositoryAPIRequest
