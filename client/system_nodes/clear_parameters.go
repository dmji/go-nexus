...
// WithDefaults hydrates default values in the clear params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ClearParams) WithDefaults() *ClearParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the clear params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ClearParams) SetDefaults() {
