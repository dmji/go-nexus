...
func (o *GetEmailConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/email] getEmailConfiguration", response, response.Code())
	}
}
...
func (o *GetEmailConfigurationOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/email][%d] getEmailConfigurationOK %s", 200, payload)
}
