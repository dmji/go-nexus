...
// WithComposerPackage adds the composerPackage to the search params
func (o *SearchParams) WithComposerPackage(composerPackage *string) *SearchParams {
	o.SetComposerPackage(composerPackage)
	return o
}

// SetComposerPackage adds the composerPackage to the search params
func (o *SearchParams) SetComposerPackage(composerPackage *string) {
	o.ComposerPackage = composerPackage
}

// WithComposerVendor adds the composerVendor to the search params
func (o *SearchParams) WithComposerVendor(composerVendor *string) *SearchParams {
	o.SetComposerVendor(composerVendor)
	return o
}

// SetComposerVendor adds the composerVendor to the search params
func (o *SearchParams) SetComposerVendor(composerVendor *string) {
	o.ComposerVendor = composerVendor
}

// WithComposerVersion adds the composerVersion to the search params
func (o *SearchParams) WithComposerVersion(composerVersion *string) *SearchParams {
	o.SetComposerVersion(composerVersion)
	return o
}

// SetComposerVersion adds the composerVersion to the search params
func (o *SearchParams) SetComposerVersion(composerVersion *string) {
...
// WithConanPackageID adds the conanPackageID to the search params
func (o *SearchParams) WithConanPackageID(conanPackageID *string) *SearchParams {
	o.SetConanPackageID(conanPackageID)
	return o
}

// SetConanPackageID adds the conanPackageId to the search params
func (o *SearchParams) SetConanPackageID(conanPackageID *string) {
	o.ConanPackageID = conanPackageID
}

// WithConanPackageRevision adds the conanPackageRevision to the search params
func (o *SearchParams) WithConanPackageRevision(conanPackageRevision *string) *SearchParams {
	o.SetConanPackageRevision(conanPackageRevision)
	return o
}

// SetConanPackageRevision adds the conanPackageRevision to the search params
func (o *SearchParams) SetConanPackageRevision(conanPackageRevision *string) {
