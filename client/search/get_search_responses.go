...
func (o *GetSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/search] GetSearch", response, response.Code())
	}
}
...
func (o *GetSearchOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/search][%d] getSearchOK %s", 200, payload)
}
...
func (o *GetSearchOK) GetPayload() *models.PageComponentXO {
	return o.Payload
}
