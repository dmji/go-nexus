...
// WithComposerPackage adds the composerPackage to the search assets params
func (o *SearchAssetsParams) WithComposerPackage(composerPackage *string) *SearchAssetsParams {
	o.SetComposerPackage(composerPackage)
	return o
}

// SetComposerPackage adds the composerPackage to the search assets params
func (o *SearchAssetsParams) SetComposerPackage(composerPackage *string) {
	o.ComposerPackage = composerPackage
}

// WithComposerVendor adds the composerVendor to the search assets params
func (o *SearchAssetsParams) WithComposerVendor(composerVendor *string) *SearchAssetsParams {
	o.SetComposerVendor(composerVendor)
	return o
}

// SetComposerVendor adds the composerVendor to the search assets params
func (o *SearchAssetsParams) SetComposerVendor(composerVendor *string) {
	o.ComposerVendor = composerVendor
}

// WithComposerVersion adds the composerVersion to the search assets params
func (o *SearchAssetsParams) WithComposerVersion(composerVersion *string) *SearchAssetsParams {
	o.SetComposerVersion(composerVersion)
	return o
}

// SetComposerVersion adds the composerVersion to the search assets params
func (o *SearchAssetsParams) SetComposerVersion(composerVersion *string) {
...
// WithConanPackageID adds the conanPackageID to the search assets params
func (o *SearchAssetsParams) WithConanPackageID(conanPackageID *string) *SearchAssetsParams {
	o.SetConanPackageID(conanPackageID)
	return o
}

// SetConanPackageID adds the conanPackageId to the search assets params
func (o *SearchAssetsParams) SetConanPackageID(conanPackageID *string) {
	o.ConanPackageID = conanPackageID
}

// WithConanPackageRevision adds the conanPackageRevision to the search assets params
func (o *SearchAssetsParams) WithConanPackageRevision(conanPackageRevision *string) *SearchAssetsParams {
	o.SetConanPackageRevision(conanPackageRevision)
	return o
}

// SetConanPackageRevision adds the conanPackageRevision to the search assets params
func (o *SearchAssetsParams) SetConanPackageRevision(conanPackageRevision *string) {
