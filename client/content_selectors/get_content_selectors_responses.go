...
func (o *GetContentSelectorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/security/content-selectors] getContentSelectors", response, response.Code())
	}
}
...
func (o *GetContentSelectorsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/security/content-selectors][%d] getContentSelectorsOK %s", 200, payload)
}
