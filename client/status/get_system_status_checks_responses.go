...
func (o *GetSystemStatusChecksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/status/check] getSystemStatusChecks", response, response.Code())
	}
}
...
func (o *GetSystemStatusChecksOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/status/check][%d] getSystemStatusChecksOK %s", 200, payload)
}
