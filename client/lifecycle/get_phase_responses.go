...
func (o *GetPhaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/lifecycle/phase] getPhase", response, response.Code())
	}
}
...
func (o *GetPhaseOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/lifecycle/phase][%d] getPhaseOK %s", 200, payload)
}
