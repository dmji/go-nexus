...
func (o *UpdatePrivilegeParams) WithBody(body *models.APIPrivilegeRepositoryViewRequest) *UpdatePrivilegeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update privilege params
func (o *UpdatePrivilegeParams) SetBody(body *models.APIPrivilegeRepositoryViewRequest) {
	o.Body = body
}
