...
func (o *CreatePrivilege1Params) WithBody(body *models.APIPrivilegeRepositoryViewRequest) *CreatePrivilege1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create privilege 1 params
func (o *CreatePrivilege1Params) SetBody(body *models.APIPrivilegeRepositoryViewRequest) {
	o.Body = body
}
