...
func (o *UpdatePrivilege1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/security/privileges/repository-admin/{privilegeName}] updatePrivilege_1", response, response.Code())
	}
}
...
func (o *UpdatePrivilege1BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-admin/{privilegeName}][%d] updatePrivilege1BadRequest", 400)
}
...
func (o *UpdatePrivilege1Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-admin/{privilegeName}][%d] updatePrivilege1Forbidden", 403)
}
...
func (o *UpdatePrivilege1NotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/repository-admin/{privilegeName}][%d] updatePrivilege1NotFound", 404)
}
