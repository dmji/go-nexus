...
DeleteSecurityPrivilegesByPrivilegeNameParams contains all the parameters to send to the API endpoint
	...
	for the delete security privileges by privilege name operation.
...
// WithDefaults hydrates default values in the delete security privileges by privilege name params (not the query body).
//
...
// SetDefaults hydrates default values in the delete security privileges by privilege name params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the delete security privileges by privilege name params
...
// SetTimeout adds the timeout to the delete security privileges by privilege name params
func (o *DeleteSecurityPrivilegesByPrivilegeNameParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the delete security privileges by privilege name params
...
// SetContext adds the context to the delete security privileges by privilege name params
func (o *DeleteSecurityPrivilegesByPrivilegeNameParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the delete security privileges by privilege name params
...
// SetHTTPClient adds the HTTPClient to the delete security privileges by privilege name params
func (o *DeleteSecurityPrivilegesByPrivilegeNameParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithPrivilegeName adds the privilegeName to the delete security privileges by privilege name params
...
// SetPrivilegeName adds the privilegeName to the delete security privileges by privilege name params
