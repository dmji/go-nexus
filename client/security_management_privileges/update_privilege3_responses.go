...
func (o *UpdatePrivilege3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/security/privileges/application/{privilegeName}] updatePrivilege_3", response, response.Code())
	}
}
...
func (o *UpdatePrivilege3BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeName}][%d] updatePrivilege3BadRequest", 400)
}
...
func (o *UpdatePrivilege3Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeName}][%d] updatePrivilege3Forbidden", 403)
}
...
func (o *UpdatePrivilege3NotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/security/privileges/application/{privilegeName}][%d] updatePrivilege3NotFound", 404)
}
