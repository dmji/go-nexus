...
func (o *UpdatePrivilege1Params) WithBody(body *models.APIPrivilegeRepositoryAdminRequest) *UpdatePrivilege1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update privilege 1 params
func (o *UpdatePrivilege1Params) SetBody(body *models.APIPrivilegeRepositoryAdminRequest) {
	o.Body = body
}
