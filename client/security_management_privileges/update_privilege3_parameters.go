...
func (o *UpdatePrivilege3Params) WithBody(body *models.APIPrivilegeApplicationRequest) *UpdatePrivilege3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update privilege 3 params
func (o *UpdatePrivilege3Params) SetBody(body *models.APIPrivilegeApplicationRequest) {
	o.Body = body
}
