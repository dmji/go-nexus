...
func (o *UpdatePrivilege4Params) WithBody(body *models.APIPrivilegeWildcardRequest) *UpdatePrivilege4Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update privilege 4 params
func (o *UpdatePrivilege4Params) SetBody(body *models.APIPrivilegeWildcardRequest) {
	o.Body = body
}
