...
func (o *UpdatePrivilege2Params) WithBody(body *models.APIPrivilegeRepositoryContentSelectorRequest) *UpdatePrivilege2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update privilege 2 params
func (o *UpdatePrivilege2Params) SetBody(body *models.APIPrivilegeRepositoryContentSelectorRequest) {
	o.Body = body
}
