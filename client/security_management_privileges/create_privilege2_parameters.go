...
func (o *CreatePrivilege2Params) WithBody(body *models.APIPrivilegeRepositoryAdminRequest) *CreatePrivilege2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create privilege 2 params
func (o *CreatePrivilege2Params) SetBody(body *models.APIPrivilegeRepositoryAdminRequest) {
	o.Body = body
}
