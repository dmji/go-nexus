...
func (o *CreatePrivilege2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/security/privileges/repository-admin] createPrivilege_2", response, response.Code())
	}
}
...
func (o *CreatePrivilege2BadRequest) Error() string {
	return fmt.Sprintf("[POST /v1/security/privileges/repository-admin][%d] createPrivilege2BadRequest", 400)
}
...
func (o *CreatePrivilege2Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/security/privileges/repository-admin][%d] createPrivilege2Forbidden", 403)
}
