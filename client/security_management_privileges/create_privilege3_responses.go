...
func (o *CreatePrivilege3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/security/privileges/wildcard] createPrivilege_3", response, response.Code())
	}
}
...
func (o *CreatePrivilege3BadRequest) Error() string {
	return fmt.Sprintf("[POST /v1/security/privileges/wildcard][%d] createPrivilege3BadRequest", 400)
}
...
func (o *CreatePrivilege3Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/security/privileges/wildcard][%d] createPrivilege3Forbidden", 403)
}
