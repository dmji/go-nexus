...
func (o *Get2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/formats/upload-specs] get_2", response, response.Code())
	}
}
...
func (o *Get2OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/formats/upload-specs][%d] get2OK %s", 200, payload)
}
