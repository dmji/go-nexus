...
func (o *GetUserSourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/security/user-sources] getUserSources", response, response.Code())
	}
}
...
func (o *GetUserSourcesOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/security/user-sources][%d] getUserSourcesOK %s", 200, payload)
}
