...
func (o *QuotaStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/blobstores/{name}/quota-status] quotaStatus", response, response.Code())
	}
}
...
func (o *QuotaStatusOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/blobstores/{name}/quota-status][%d] quotaStatusOK %s", 200, payload)
}
