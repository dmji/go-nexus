...
func (o *ListBlobStoresReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/blobstores] listBlobStores", response, response.Code())
	}
}
...
func (o *ListBlobStoresOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/blobstores][%d] listBlobStoresOK %s", 200, payload)
}
