...
func (o *GetFileBlobStoreConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/blobstores/file/{name}] getFileBlobStoreConfiguration", response, response.Code())
	}
}
...
func (o *GetFileBlobStoreConfigurationOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/blobstores/file/{name}][%d] getFileBlobStoreConfigurationOK %s", 200, payload)
}
