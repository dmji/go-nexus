...
func (o *UpdateRepository39Params) WithBody(body *models.RubyGemsGroupRepositoryAPIRequest) *UpdateRepository39Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 39 params
func (o *UpdateRepository39Params) SetBody(body *models.RubyGemsGroupRepositoryAPIRequest) {
	o.Body = body
}
