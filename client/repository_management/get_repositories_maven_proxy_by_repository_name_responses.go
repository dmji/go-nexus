...
// IsSuccess returns true when this get repositories maven proxy by repository name o k response has a 2xx status code
func (o *GetRepositoriesMavenProxyByRepositoryNameOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get repositories maven proxy by repository name o k response has a 3xx status code
func (o *GetRepositoriesMavenProxyByRepositoryNameOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get repositories maven proxy by repository name o k response has a 4xx status code
func (o *GetRepositoriesMavenProxyByRepositoryNameOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get repositories maven proxy by repository name o k response has a 5xx status code
func (o *GetRepositoriesMavenProxyByRepositoryNameOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get repositories maven proxy by repository name o k response a status code equal to that given
func (o *GetRepositoriesMavenProxyByRepositoryNameOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get repositories maven proxy by repository name o k response
