...
func (o *CreateRepository39Params) WithBody(body *models.RubyGemsGroupRepositoryAPIRequest) *CreateRepository39Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 39 params
func (o *CreateRepository39Params) SetBody(body *models.RubyGemsGroupRepositoryAPIRequest) {
	o.Body = body
}
