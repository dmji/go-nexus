...
func (o *CreateRepository12Params) WithBody(body *models.ComposerProxyRepositoryAPIRequest) *CreateRepository12Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 12 params
func (o *CreateRepository12Params) SetBody(body *models.ComposerProxyRepositoryAPIRequest) {
	o.Body = body
}
