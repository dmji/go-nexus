...
func (o *GetRepository12Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/cocoapods/proxy/{repositoryName}] getRepository_12", response, response.Code())
	}
}
...
func (o *GetRepository12OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/cocoapods/proxy/{repositoryName}][%d] getRepository12OK %s", 200, payload)
}
...
func (o *GetRepository12OK) GetPayload() *models.SimpleAPIProxyRepository {
	return o.Payload
}
