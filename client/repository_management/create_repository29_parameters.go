...
func (o *CreateRepository29Params) WithBody(body *models.NugetGroupRepositoryAPIRequest) *CreateRepository29Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 29 params
func (o *CreateRepository29Params) SetBody(body *models.NugetGroupRepositoryAPIRequest) {
	o.Body = body
}
