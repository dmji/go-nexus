...
func (o *CreateRepository32Params) WithBody(body *models.P2ProxyRepositoryAPIRequest) *CreateRepository32Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 32 params
func (o *CreateRepository32Params) SetBody(body *models.P2ProxyRepositoryAPIRequest) {
	o.Body = body
}
