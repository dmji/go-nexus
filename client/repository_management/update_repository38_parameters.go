...
func (o *UpdateRepository38Params) WithBody(body *models.RProxyRepositoryAPIRequest) *UpdateRepository38Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 38 params
func (o *UpdateRepository38Params) SetBody(body *models.RProxyRepositoryAPIRequest) {
	o.Body = body
}
