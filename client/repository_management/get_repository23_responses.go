...
func (o *GetRepository23Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/go/proxy/{repositoryName}] getRepository_23", response, response.Code())
	}
}
...
func (o *GetRepository23OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/go/proxy/{repositoryName}][%d] getRepository23OK %s", 200, payload)
}
