...
func (o *CreateRepository35Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/pypi/proxy] createRepository_35", response, response.Code())
	}
}
...
func (o *CreateRepository35Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/proxy][%d] createRepository35Created", 201)
}
...
func (o *CreateRepository35Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/proxy][%d] createRepository35Unauthorized", 401)
}
...
func (o *CreateRepository35Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/proxy][%d] createRepository35Forbidden", 403)
}
