...
func (o *UpdateRepository4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository4BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/maven/proxy/{repositoryName}] updateRepository_4", response, response.Code())
	}
}
...
func (o *UpdateRepository4NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/proxy/{repositoryName}][%d] updateRepository4NoContent", 204)
}
...
// NewUpdateRepository4BadRequest creates a UpdateRepository4BadRequest with default headers values
func NewUpdateRepository4BadRequest() *UpdateRepository4BadRequest {
	return &UpdateRepository4BadRequest{}
}

/*
UpdateRepository4BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository4BadRequest struct {
}

// IsSuccess returns true when this update repository4 bad request response has a 2xx status code
func (o *UpdateRepository4BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository4 bad request response has a 3xx status code
func (o *UpdateRepository4BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository4 bad request response has a 4xx status code
func (o *UpdateRepository4BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository4 bad request response has a 5xx status code
func (o *UpdateRepository4BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository4 bad request response a status code equal to that given
func (o *UpdateRepository4BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository4 bad request response
func (o *UpdateRepository4BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository4BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/proxy/{repositoryName}][%d] updateRepository4BadRequest", 400)
}

func (o *UpdateRepository4BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/proxy/{repositoryName}][%d] updateRepository4BadRequest", 400)
}

func (o *UpdateRepository4BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository4Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/proxy/{repositoryName}][%d] updateRepository4Unauthorized", 401)
}
...
func (o *UpdateRepository4Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/proxy/{repositoryName}][%d] updateRepository4Forbidden", 403)
}
