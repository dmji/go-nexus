...
func (o *GetRepository9Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/cargo/group/{repositoryName}] getRepository_9", response, response.Code())
	}
}
...
func (o *GetRepository9OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/cargo/group/{repositoryName}][%d] getRepository9OK %s", 200, payload)
}
...
func (o *GetRepository9OK) GetPayload() *models.CargoGroupAPIRepository {
	return o.Payload
}
