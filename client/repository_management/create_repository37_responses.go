...
func (o *CreateRepository37Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 405:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/r/hosted] createRepository_37", response, response.Code())
	}
}
...
func (o *CreateRepository37Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/hosted][%d] createRepository37Created", 201)
}
...
func (o *CreateRepository37Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/hosted][%d] createRepository37Unauthorized", 401)
}
...
func (o *CreateRepository37Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/hosted][%d] createRepository37Forbidden", 403)
}
...
func (o *CreateRepository37MethodNotAllowed) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/hosted][%d] createRepository37MethodNotAllowed", 405)
}
