...
func (o *UpdateRepository28Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository28BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/npm/proxy/{repositoryName}] updateRepository_28", response, response.Code())
	}
}
...
func (o *UpdateRepository28NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/npm/proxy/{repositoryName}][%d] updateRepository28NoContent", 204)
}
...
// NewUpdateRepository28BadRequest creates a UpdateRepository28BadRequest with default headers values
func NewUpdateRepository28BadRequest() *UpdateRepository28BadRequest {
	return &UpdateRepository28BadRequest{}
}

/*
UpdateRepository28BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository28BadRequest struct {
}

// IsSuccess returns true when this update repository28 bad request response has a 2xx status code
func (o *UpdateRepository28BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository28 bad request response has a 3xx status code
func (o *UpdateRepository28BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository28 bad request response has a 4xx status code
func (o *UpdateRepository28BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository28 bad request response has a 5xx status code
func (o *UpdateRepository28BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository28 bad request response a status code equal to that given
func (o *UpdateRepository28BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository28 bad request response
func (o *UpdateRepository28BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository28BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/npm/proxy/{repositoryName}][%d] updateRepository28BadRequest", 400)
}

func (o *UpdateRepository28BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/npm/proxy/{repositoryName}][%d] updateRepository28BadRequest", 400)
}

func (o *UpdateRepository28BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository28Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/npm/proxy/{repositoryName}][%d] updateRepository28Unauthorized", 401)
}
...
func (o *UpdateRepository28Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/npm/proxy/{repositoryName}][%d] updateRepository28Forbidden", 403)
}
