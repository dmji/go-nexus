...
func (o *GetRepositories1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories] getRepositories_1", response, response.Code())
	}
}
...
func (o *GetRepositories1OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories][%d] getRepositories1OK %s", 200, payload)
}
