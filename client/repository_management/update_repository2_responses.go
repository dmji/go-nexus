...
func (o *UpdateRepository2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository2BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/maven/group/{repositoryName}] updateRepository_2", response, response.Code())
	}
}
...
func (o *UpdateRepository2NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/group/{repositoryName}][%d] updateRepository2NoContent", 204)
}
...
// NewUpdateRepository2BadRequest creates a UpdateRepository2BadRequest with default headers values
func NewUpdateRepository2BadRequest() *UpdateRepository2BadRequest {
	return &UpdateRepository2BadRequest{}
}

/*
UpdateRepository2BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository2BadRequest struct {
}

// IsSuccess returns true when this update repository2 bad request response has a 2xx status code
func (o *UpdateRepository2BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository2 bad request response has a 3xx status code
func (o *UpdateRepository2BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository2 bad request response has a 4xx status code
func (o *UpdateRepository2BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository2 bad request response has a 5xx status code
func (o *UpdateRepository2BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository2 bad request response a status code equal to that given
func (o *UpdateRepository2BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository2 bad request response
func (o *UpdateRepository2BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository2BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/group/{repositoryName}][%d] updateRepository2BadRequest", 400)
}

func (o *UpdateRepository2BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/group/{repositoryName}][%d] updateRepository2BadRequest", 400)
}

func (o *UpdateRepository2BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository2Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/group/{repositoryName}][%d] updateRepository2Unauthorized", 401)
}
...
func (o *UpdateRepository2Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/maven/group/{repositoryName}][%d] updateRepository2Forbidden", 403)
}
