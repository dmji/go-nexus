...
func (o *CreateRepository22Params) WithBody(body *models.GolangProxyRepositoryAPIRequest) *CreateRepository22Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 22 params
func (o *CreateRepository22Params) SetBody(body *models.GolangProxyRepositoryAPIRequest) {
	o.Body = body
}
