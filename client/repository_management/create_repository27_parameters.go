...
func (o *CreateRepository27Params) WithBody(body *models.NpmHostedRepositoryAPIRequest) *CreateRepository27Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 27 params
func (o *CreateRepository27Params) SetBody(body *models.NpmHostedRepositoryAPIRequest) {
	o.Body = body
}
