...
func (o *UpdateRepository11Params) WithBody(body *models.CocoapodsProxyRepositoryAPIRequest) *UpdateRepository11Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 11 params
func (o *UpdateRepository11Params) SetBody(body *models.CocoapodsProxyRepositoryAPIRequest) {
	o.Body = body
}
