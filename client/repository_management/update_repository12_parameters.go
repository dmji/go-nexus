...
func (o *UpdateRepository12Params) WithBody(body *models.ComposerProxyRepositoryAPIRequest) *UpdateRepository12Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 12 params
func (o *UpdateRepository12Params) SetBody(body *models.ComposerProxyRepositoryAPIRequest) {
	o.Body = body
}
