...
func (o *GetRepository13Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/composer/proxy/{repositoryName}] getRepository_13", response, response.Code())
	}
}
...
func (o *GetRepository13OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/composer/proxy/{repositoryName}][%d] getRepository13OK %s", 200, payload)
}
...
func (o *GetRepository13OK) GetPayload() *models.SimpleAPIProxyRepository {
	return o.Payload
}
