...
func (o *GetRepository21Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/gitlfs/hosted/{repositoryName}] getRepository_21", response, response.Code())
	}
}
...
func (o *GetRepository21OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/gitlfs/hosted/{repositoryName}][%d] getRepository21OK %s", 200, payload)
}
...
func (o *GetRepository21OK) GetPayload() *models.SimpleAPIHostedRepository {
	return o.Payload
}
