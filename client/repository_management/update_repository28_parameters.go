...
func (o *UpdateRepository28Params) WithBody(body *models.NpmProxyRepositoryAPIRequest) *UpdateRepository28Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 28 params
func (o *UpdateRepository28Params) SetBody(body *models.NpmProxyRepositoryAPIRequest) {
	o.Body = body
}
