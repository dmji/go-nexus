...
func (o *UpdateRepository33Params) WithBody(body *models.PypiGroupRepositoryAPIRequest) *UpdateRepository33Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 33 params
func (o *UpdateRepository33Params) SetBody(body *models.PypiGroupRepositoryAPIRequest) {
	o.Body = body
}
