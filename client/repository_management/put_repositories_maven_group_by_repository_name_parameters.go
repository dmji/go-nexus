...
PutRepositoriesMavenGroupByRepositoryNameParams contains all the parameters to send to the API endpoint
	...
	for the put repositories maven group by repository name operation.
...
// WithDefaults hydrates default values in the put repositories maven group by repository name params (not the query body).
//
...
// SetDefaults hydrates default values in the put repositories maven group by repository name params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the put repositories maven group by repository name params
...
// SetTimeout adds the timeout to the put repositories maven group by repository name params
func (o *PutRepositoriesMavenGroupByRepositoryNameParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the put repositories maven group by repository name params
...
// SetContext adds the context to the put repositories maven group by repository name params
func (o *PutRepositoriesMavenGroupByRepositoryNameParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the put repositories maven group by repository name params
...
// SetHTTPClient adds the HTTPClient to the put repositories maven group by repository name params
func (o *PutRepositoriesMavenGroupByRepositoryNameParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithBody adds the body to the put repositories maven group by repository name params
...
// SetBody adds the body to the put repositories maven group by repository name params
func (o *PutRepositoriesMavenGroupByRepositoryNameParams) SetBody(body *models.MavenGroupRepositoryAPIRequest) {
	o.Body = body
}

// WithRepositoryName adds the repositoryName to the put repositories maven group by repository name params
...
// SetRepositoryName adds the repositoryName to the put repositories maven group by repository name params
