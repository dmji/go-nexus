...
func (o *GetRepository33Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/p2/proxy/{repositoryName}] getRepository_33", response, response.Code())
	}
}
...
func (o *GetRepository33OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/p2/proxy/{repositoryName}][%d] getRepository33OK %s", 200, payload)
}
