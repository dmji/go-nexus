...
func (o *CreateRepository16Params) WithBody(body *models.CondaProxyRepositoryAPIRequest) *CreateRepository16Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 16 params
func (o *CreateRepository16Params) SetBody(body *models.CondaProxyRepositoryAPIRequest) {
	o.Body = body
}
