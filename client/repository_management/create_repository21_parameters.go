...
func (o *CreateRepository21Params) WithBody(body *models.GolangGroupRepositoryAPIRequest) *CreateRepository21Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 21 params
func (o *CreateRepository21Params) SetBody(body *models.GolangGroupRepositoryAPIRequest) {
	o.Body = body
}
