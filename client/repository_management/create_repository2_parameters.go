...
func (o *CreateRepository2Params) WithBody(body *models.MavenGroupRepositoryAPIRequest) *CreateRepository2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 2 params
func (o *CreateRepository2Params) SetBody(body *models.MavenGroupRepositoryAPIRequest) {
	o.Body = body
}
