...
func (o *UpdateRepository29Params) WithBody(body *models.NugetGroupRepositoryAPIRequest) *UpdateRepository29Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 29 params
func (o *UpdateRepository29Params) SetBody(body *models.NugetGroupRepositoryAPIRequest) {
	o.Body = body
}
