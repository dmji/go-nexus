...
func (o *UpdateRepository3Params) WithBody(body *models.MavenHostedRepositoryAPIRequest) *UpdateRepository3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 3 params
func (o *UpdateRepository3Params) SetBody(body *models.MavenHostedRepositoryAPIRequest) {
	o.Body = body
}
