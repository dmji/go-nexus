...
func (o *CreateRepository25Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/huggingface/proxy] createRepository_25", response, response.Code())
	}
}
...
func (o *CreateRepository25Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/huggingface/proxy][%d] createRepository25Created", 201)
}
...
func (o *CreateRepository25Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/huggingface/proxy][%d] createRepository25Unauthorized", 401)
}
...
func (o *CreateRepository25Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/huggingface/proxy][%d] createRepository25Forbidden", 403)
}
