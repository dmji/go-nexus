...
func (o *CreateRepository34Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/pypi/hosted] createRepository_34", response, response.Code())
	}
}
...
func (o *CreateRepository34Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/hosted][%d] createRepository34Created", 201)
}
...
func (o *CreateRepository34Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/hosted][%d] createRepository34Unauthorized", 401)
}
...
func (o *CreateRepository34Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/hosted][%d] createRepository34Forbidden", 403)
}
