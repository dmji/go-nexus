...
func (o *UpdateRepository15Params) WithBody(body *models.ConanProxyRepositoryAPIRequest) *UpdateRepository15Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 15 params
func (o *UpdateRepository15Params) SetBody(body *models.ConanProxyRepositoryAPIRequest) {
	o.Body = body
}
