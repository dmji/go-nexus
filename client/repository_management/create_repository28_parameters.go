...
func (o *CreateRepository28Params) WithBody(body *models.NpmProxyRepositoryAPIRequest) *CreateRepository28Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 28 params
func (o *CreateRepository28Params) SetBody(body *models.NpmProxyRepositoryAPIRequest) {
	o.Body = body
}
