...
func (o *GetRepository8Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/raw/proxy/{repositoryName}] getRepository_8", response, response.Code())
	}
}
...
func (o *GetRepository8OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/raw/proxy/{repositoryName}][%d] getRepository8OK %s", 200, payload)
}
