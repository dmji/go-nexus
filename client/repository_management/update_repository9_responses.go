...
func (o *UpdateRepository9Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository9BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/cargo/hosted/{repositoryName}] updateRepository_9", response, response.Code())
	}
}
...
func (o *UpdateRepository9NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/hosted/{repositoryName}][%d] updateRepository9NoContent", 204)
}
...
// NewUpdateRepository9BadRequest creates a UpdateRepository9BadRequest with default headers values
func NewUpdateRepository9BadRequest() *UpdateRepository9BadRequest {
	return &UpdateRepository9BadRequest{}
}

/*
UpdateRepository9BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository9BadRequest struct {
}

// IsSuccess returns true when this update repository9 bad request response has a 2xx status code
func (o *UpdateRepository9BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository9 bad request response has a 3xx status code
func (o *UpdateRepository9BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository9 bad request response has a 4xx status code
func (o *UpdateRepository9BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository9 bad request response has a 5xx status code
func (o *UpdateRepository9BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository9 bad request response a status code equal to that given
func (o *UpdateRepository9BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository9 bad request response
func (o *UpdateRepository9BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository9BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/hosted/{repositoryName}][%d] updateRepository9BadRequest", 400)
}

func (o *UpdateRepository9BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/hosted/{repositoryName}][%d] updateRepository9BadRequest", 400)
}

func (o *UpdateRepository9BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository9Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/hosted/{repositoryName}][%d] updateRepository9Unauthorized", 401)
}
...
func (o *UpdateRepository9Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/hosted/{repositoryName}][%d] updateRepository9Forbidden", 403)
}
