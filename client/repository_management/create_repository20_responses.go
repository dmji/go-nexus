...
func (o *CreateRepository20Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/gitlfs/hosted] createRepository_20", response, response.Code())
	}
}
...
func (o *CreateRepository20Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/gitlfs/hosted][%d] createRepository20Created", 201)
}
...
func (o *CreateRepository20Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/gitlfs/hosted][%d] createRepository20Unauthorized", 401)
}
...
func (o *CreateRepository20Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/gitlfs/hosted][%d] createRepository20Forbidden", 403)
}
