...
func (o *CreateRepository26Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/npm/group] createRepository_26", response, response.Code())
	}
}
...
func (o *CreateRepository26Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/group][%d] createRepository26Created", 201)
}
...
func (o *CreateRepository26Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/group][%d] createRepository26Unauthorized", 401)
}
...
func (o *CreateRepository26Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/group][%d] createRepository26Forbidden", 403)
}
