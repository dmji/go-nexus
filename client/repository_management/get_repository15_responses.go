...
func (o *GetRepository15Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/conan/hosted/{repositoryName}] getRepository_15", response, response.Code())
	}
}
...
func (o *GetRepository15OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/conan/hosted/{repositoryName}][%d] getRepository15OK %s", 200, payload)
}
