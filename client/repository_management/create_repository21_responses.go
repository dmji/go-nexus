...
func (o *CreateRepository21Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	case 405:
		result := NewCreateRepository21MethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/go/group] createRepository_21", response, response.Code())
	}
}
...
func (o *CreateRepository21Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/go/group][%d] createRepository21Created", 201)
}
...
func (o *CreateRepository21Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/go/group][%d] createRepository21Unauthorized", 401)
}
...
func (o *CreateRepository21Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/go/group][%d] createRepository21Forbidden", 403)
}
...
// NewCreateRepository21MethodNotAllowed creates a CreateRepository21MethodNotAllowed with default headers values
func NewCreateRepository21MethodNotAllowed() *CreateRepository21MethodNotAllowed {
	return &CreateRepository21MethodNotAllowed{}
}

/*
CreateRepository21MethodNotAllowed describes a response with status code 405, with default header values.

Feature is disabled in High Availability
*/
type CreateRepository21MethodNotAllowed struct {
}

// IsSuccess returns true when this create repository21 method not allowed response has a 2xx status code
func (o *CreateRepository21MethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create repository21 method not allowed response has a 3xx status code
func (o *CreateRepository21MethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create repository21 method not allowed response has a 4xx status code
func (o *CreateRepository21MethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this create repository21 method not allowed response has a 5xx status code
func (o *CreateRepository21MethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this create repository21 method not allowed response a status code equal to that given
func (o *CreateRepository21MethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the create repository21 method not allowed response
func (o *CreateRepository21MethodNotAllowed) Code() int {
	return 405
}

func (o *CreateRepository21MethodNotAllowed) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/go/group][%d] createRepository21MethodNotAllowed", 405)
}

func (o *CreateRepository21MethodNotAllowed) String() string {
	return fmt.Sprintf("[POST /v1/repositories/go/group][%d] createRepository21MethodNotAllowed", 405)
}

func (o *CreateRepository21MethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
