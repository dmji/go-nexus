...
func (o *GetRepository26Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/huggingface/proxy/{repositoryName}] getRepository_26", response, response.Code())
	}
}
...
func (o *GetRepository26OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/huggingface/proxy/{repositoryName}][%d] getRepository26OK %s", 200, payload)
}
...
func (o *GetRepository26OK) GetPayload() *models.SimpleAPIProxyRepository {
	return o.Payload
}
