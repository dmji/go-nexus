...
func (o *UpdateRepository40Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository40BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/rubygems/hosted/{repositoryName}] updateRepository_40", response, response.Code())
	}
}
...
func (o *UpdateRepository40NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/hosted/{repositoryName}][%d] updateRepository40NoContent", 204)
}
...
// NewUpdateRepository40BadRequest creates a UpdateRepository40BadRequest with default headers values
func NewUpdateRepository40BadRequest() *UpdateRepository40BadRequest {
	return &UpdateRepository40BadRequest{}
}

/*
UpdateRepository40BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository40BadRequest struct {
}

// IsSuccess returns true when this update repository40 bad request response has a 2xx status code
func (o *UpdateRepository40BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository40 bad request response has a 3xx status code
func (o *UpdateRepository40BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository40 bad request response has a 4xx status code
func (o *UpdateRepository40BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository40 bad request response has a 5xx status code
func (o *UpdateRepository40BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository40 bad request response a status code equal to that given
func (o *UpdateRepository40BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository40 bad request response
func (o *UpdateRepository40BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository40BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/hosted/{repositoryName}][%d] updateRepository40BadRequest", 400)
}

func (o *UpdateRepository40BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/hosted/{repositoryName}][%d] updateRepository40BadRequest", 400)
}

func (o *UpdateRepository40BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository40Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/hosted/{repositoryName}][%d] updateRepository40Unauthorized", 401)
}
...
func (o *UpdateRepository40Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/hosted/{repositoryName}][%d] updateRepository40Forbidden", 403)
}
