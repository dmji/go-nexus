...
func (o *CreateRepository13Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/conan/group] createRepository_13", response, response.Code())
	}
}
...
func (o *CreateRepository13Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/conan/group][%d] createRepository13Created", 201)
}
...
func (o *CreateRepository13Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/conan/group][%d] createRepository13Unauthorized", 401)
}
...
func (o *CreateRepository13Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/conan/group][%d] createRepository13Forbidden", 403)
}
