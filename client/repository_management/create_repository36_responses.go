...
func (o *CreateRepository36Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 405:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/r/group] createRepository_36", response, response.Code())
	}
}
...
func (o *CreateRepository36Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/group][%d] createRepository36Created", 201)
}
...
func (o *CreateRepository36Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/group][%d] createRepository36Unauthorized", 401)
}
...
func (o *CreateRepository36Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/group][%d] createRepository36Forbidden", 403)
}
...
func (o *CreateRepository36MethodNotAllowed) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/group][%d] createRepository36MethodNotAllowed", 405)
}
