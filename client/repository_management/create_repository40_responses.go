...
func (o *CreateRepository40Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/rubygems/hosted] createRepository_40", response, response.Code())
	}
}
...
func (o *CreateRepository40Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/hosted][%d] createRepository40Created", 201)
}
...
func (o *CreateRepository40Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/hosted][%d] createRepository40Unauthorized", 401)
}
...
func (o *CreateRepository40Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/hosted][%d] createRepository40Forbidden", 403)
}
