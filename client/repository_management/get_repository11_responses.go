...
func (o *GetRepository11Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/cargo/proxy/{repositoryName}] getRepository_11", response, response.Code())
	}
}
...
func (o *GetRepository11OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/cargo/proxy/{repositoryName}][%d] getRepository11OK %s", 200, payload)
}
...
func (o *GetRepository11OK) GetPayload() *models.CargoProxyAPIRepository {
	return o.Payload
}
