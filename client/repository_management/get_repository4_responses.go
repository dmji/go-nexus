...
func (o *GetRepository4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/maven/hosted/{repositoryName}] getRepository_4", response, response.Code())
	}
}
...
func (o *GetRepository4OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/maven/hosted/{repositoryName}][%d] getRepository4OK %s", 200, payload)
}
...
func (o *GetRepository4OK) GetPayload() *models.MavenHostedAPIRepository {
	return o.Payload
}
