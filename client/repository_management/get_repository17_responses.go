...
func (o *GetRepository17Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/conda/proxy/{repositoryName}] getRepository_17", response, response.Code())
	}
}
...
func (o *GetRepository17OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/conda/proxy/{repositoryName}][%d] getRepository17OK %s", 200, payload)
}
