...
func (o *CreateRepository20Params) WithBody(body *models.GitLfsHostedRepositoryAPIRequest) *CreateRepository20Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 20 params
func (o *CreateRepository20Params) SetBody(body *models.GitLfsHostedRepositoryAPIRequest) {
	o.Body = body
}
