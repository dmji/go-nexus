...
func (o *UpdateRepository39Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository39BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/rubygems/group/{repositoryName}] updateRepository_39", response, response.Code())
	}
}
...
func (o *UpdateRepository39NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/group/{repositoryName}][%d] updateRepository39NoContent", 204)
}
...
// NewUpdateRepository39BadRequest creates a UpdateRepository39BadRequest with default headers values
func NewUpdateRepository39BadRequest() *UpdateRepository39BadRequest {
	return &UpdateRepository39BadRequest{}
}

/*
UpdateRepository39BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository39BadRequest struct {
}

// IsSuccess returns true when this update repository39 bad request response has a 2xx status code
func (o *UpdateRepository39BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository39 bad request response has a 3xx status code
func (o *UpdateRepository39BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository39 bad request response has a 4xx status code
func (o *UpdateRepository39BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository39 bad request response has a 5xx status code
func (o *UpdateRepository39BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository39 bad request response a status code equal to that given
func (o *UpdateRepository39BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository39 bad request response
func (o *UpdateRepository39BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository39BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/group/{repositoryName}][%d] updateRepository39BadRequest", 400)
}

func (o *UpdateRepository39BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/group/{repositoryName}][%d] updateRepository39BadRequest", 400)
}

func (o *UpdateRepository39BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository39Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/group/{repositoryName}][%d] updateRepository39Unauthorized", 401)
}
...
func (o *UpdateRepository39Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/rubygems/group/{repositoryName}][%d] updateRepository39Forbidden", 403)
}
