...
func (o *CreateRepository37Params) WithBody(body *models.RHostedRepositoryAPIRequest) *CreateRepository37Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 37 params
func (o *CreateRepository37Params) SetBody(body *models.RHostedRepositoryAPIRequest) {
	o.Body = body
}
