...
func (o *GetRepository3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/maven/group/{repositoryName}] getRepository_3", response, response.Code())
	}
}
...
func (o *GetRepository3OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/maven/group/{repositoryName}][%d] getRepository3OK %s", 200, payload)
}
...
func (o *GetRepository3OK) GetPayload() *models.SimpleAPIGroupRepository {
	return o.Payload
}
