...
func (o *CreateRepository33Params) WithBody(body *models.PypiGroupRepositoryAPIRequest) *CreateRepository33Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 33 params
func (o *CreateRepository33Params) SetBody(body *models.PypiGroupRepositoryAPIRequest) {
	o.Body = body
}
