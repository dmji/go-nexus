...
func (o *CreateRepository29Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/nuget/group] createRepository_29", response, response.Code())
	}
}
...
func (o *CreateRepository29Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/group][%d] createRepository29Created", 201)
}
...
func (o *CreateRepository29Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/group][%d] createRepository29Unauthorized", 401)
}
...
func (o *CreateRepository29Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/group][%d] createRepository29Forbidden", 403)
}
