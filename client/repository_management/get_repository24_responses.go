...
func (o *GetRepository24Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/helm/hosted/{repositoryName}] getRepository_24", response, response.Code())
	}
}
...
func (o *GetRepository24OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/helm/hosted/{repositoryName}][%d] getRepository24OK %s", 200, payload)
}
