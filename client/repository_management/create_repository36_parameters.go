...
func (o *CreateRepository36Params) WithBody(body *models.RGroupRepositoryAPIRequest) *CreateRepository36Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 36 params
func (o *CreateRepository36Params) SetBody(body *models.RGroupRepositoryAPIRequest) {
	o.Body = body
}
