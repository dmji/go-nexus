...
func (o *GetRepository14Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/conan/group/{repositoryName}] getRepository_14", response, response.Code())
	}
}
...
func (o *GetRepository14OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/conan/group/{repositoryName}][%d] getRepository14OK %s", 200, payload)
}
