...
func (o *GetRepository40Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/rubygems/group/{repositoryName}] getRepository_40", response, response.Code())
	}
}
...
func (o *GetRepository40OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/rubygems/group/{repositoryName}][%d] getRepository40OK %s", 200, payload)
}
...
func (o *GetRepository40OK) GetPayload() *models.SimpleAPIGroupRepository {
	return o.Payload
}
