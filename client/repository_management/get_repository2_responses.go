...
func (o *GetRepository2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/apt/proxy/{repositoryName}] getRepository_2", response, response.Code())
	}
}
...
func (o *GetRepository2OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/apt/proxy/{repositoryName}][%d] getRepository2OK %s", 200, payload)
}
...
func (o *GetRepository2OK) GetPayload() *models.AptProxyAPIRepository {
	return o.Payload
}
