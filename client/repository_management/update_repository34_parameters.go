...
func (o *UpdateRepository34Params) WithBody(body *models.PypiHostedRepositoryAPIRequest) *UpdateRepository34Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 34 params
func (o *UpdateRepository34Params) SetBody(body *models.PypiHostedRepositoryAPIRequest) {
	o.Body = body
}
