...
func (o *GetRepository1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/apt/hosted/{repositoryName}] getRepository_1", response, response.Code())
	}
}
...
func (o *GetRepository1OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/apt/hosted/{repositoryName}][%d] getRepository1OK %s", 200, payload)
}
...
func (o *GetRepository1OK) GetPayload() *models.AptHostedAPIRepository {
	return o.Payload
}
