...
func (o *CreateRepository30Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/nuget/hosted] createRepository_30", response, response.Code())
	}
}
...
func (o *CreateRepository30Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/hosted][%d] createRepository30Created", 201)
}
...
func (o *CreateRepository30Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/hosted][%d] createRepository30Unauthorized", 401)
}
...
func (o *CreateRepository30Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/nuget/hosted][%d] createRepository30Forbidden", 403)
}
