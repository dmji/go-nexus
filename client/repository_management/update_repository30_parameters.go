...
func (o *UpdateRepository30Params) WithBody(body *models.NugetHostedRepositoryAPIRequest) *UpdateRepository30Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 30 params
func (o *UpdateRepository30Params) SetBody(body *models.NugetHostedRepositoryAPIRequest) {
	o.Body = body
}
