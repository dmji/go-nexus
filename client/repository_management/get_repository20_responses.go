...
func (o *GetRepository20Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/docker/proxy/{repositoryName}] getRepository_20", response, response.Code())
	}
}
...
func (o *GetRepository20OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/docker/proxy/{repositoryName}][%d] getRepository20OK %s", 200, payload)
}
