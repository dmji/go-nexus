...
func (o *CreateRepository3Params) WithBody(body *models.MavenHostedRepositoryAPIRequest) *CreateRepository3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 3 params
func (o *CreateRepository3Params) SetBody(body *models.MavenHostedRepositoryAPIRequest) {
	o.Body = body
}
