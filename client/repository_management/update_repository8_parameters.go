...
func (o *UpdateRepository8Params) WithBody(body *models.CargoGroupRepositoryAPIRequest) *UpdateRepository8Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 8 params
func (o *UpdateRepository8Params) SetBody(body *models.CargoGroupRepositoryAPIRequest) {
	o.Body = body
}
