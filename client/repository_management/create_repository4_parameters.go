...
func (o *CreateRepository4Params) WithBody(body *models.MavenProxyRepositoryAPIRequest) *CreateRepository4Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 4 params
func (o *CreateRepository4Params) SetBody(body *models.MavenProxyRepositoryAPIRequest) {
	o.Body = body
}
