...
func (o *GetRepository7Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/raw/hosted/{repositoryName}] getRepository_7", response, response.Code())
	}
}
...
func (o *GetRepository7OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/raw/hosted/{repositoryName}][%d] getRepository7OK %s", 200, payload)
}
