...
func (o *GetRepository5Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/maven/proxy/{repositoryName}] getRepository_5", response, response.Code())
	}
}
...
func (o *GetRepository5OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/maven/proxy/{repositoryName}][%d] getRepository5OK %s", 200, payload)
}
...
func (o *GetRepository5OK) GetPayload() *models.MavenProxyAPIRepository {
	return o.Payload
}
