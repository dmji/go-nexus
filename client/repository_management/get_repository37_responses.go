...
func (o *GetRepository37Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/r/group/{repositoryName}] getRepository_37", response, response.Code())
	}
}
...
func (o *GetRepository37OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/r/group/{repositoryName}][%d] getRepository37OK %s", 200, payload)
}
...
func (o *GetRepository37OK) GetPayload() *models.SimpleAPIGroupRepository {
	return o.Payload
}
