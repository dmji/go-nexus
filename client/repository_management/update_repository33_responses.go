...
func (o *UpdateRepository33Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository33BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/pypi/group/{repositoryName}] updateRepository_33", response, response.Code())
	}
}
...
func (o *UpdateRepository33NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/group/{repositoryName}][%d] updateRepository33NoContent", 204)
}
...
// NewUpdateRepository33BadRequest creates a UpdateRepository33BadRequest with default headers values
func NewUpdateRepository33BadRequest() *UpdateRepository33BadRequest {
	return &UpdateRepository33BadRequest{}
}

/*
UpdateRepository33BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository33BadRequest struct {
}

// IsSuccess returns true when this update repository33 bad request response has a 2xx status code
func (o *UpdateRepository33BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository33 bad request response has a 3xx status code
func (o *UpdateRepository33BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository33 bad request response has a 4xx status code
func (o *UpdateRepository33BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository33 bad request response has a 5xx status code
func (o *UpdateRepository33BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository33 bad request response a status code equal to that given
func (o *UpdateRepository33BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository33 bad request response
func (o *UpdateRepository33BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository33BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/group/{repositoryName}][%d] updateRepository33BadRequest", 400)
}

func (o *UpdateRepository33BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/group/{repositoryName}][%d] updateRepository33BadRequest", 400)
}

func (o *UpdateRepository33BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository33Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/group/{repositoryName}][%d] updateRepository33Unauthorized", 401)
}
...
func (o *UpdateRepository33Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/group/{repositoryName}][%d] updateRepository33Forbidden", 403)
}
