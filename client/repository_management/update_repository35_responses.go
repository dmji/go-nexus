...
func (o *UpdateRepository35Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository35BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/pypi/proxy/{repositoryName}] updateRepository_35", response, response.Code())
	}
}
...
func (o *UpdateRepository35NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/proxy/{repositoryName}][%d] updateRepository35NoContent", 204)
}
...
// NewUpdateRepository35BadRequest creates a UpdateRepository35BadRequest with default headers values
func NewUpdateRepository35BadRequest() *UpdateRepository35BadRequest {
	return &UpdateRepository35BadRequest{}
}

/*
UpdateRepository35BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository35BadRequest struct {
}

// IsSuccess returns true when this update repository35 bad request response has a 2xx status code
func (o *UpdateRepository35BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository35 bad request response has a 3xx status code
func (o *UpdateRepository35BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository35 bad request response has a 4xx status code
func (o *UpdateRepository35BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository35 bad request response has a 5xx status code
func (o *UpdateRepository35BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository35 bad request response a status code equal to that given
func (o *UpdateRepository35BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository35 bad request response
func (o *UpdateRepository35BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository35BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/proxy/{repositoryName}][%d] updateRepository35BadRequest", 400)
}

func (o *UpdateRepository35BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/proxy/{repositoryName}][%d] updateRepository35BadRequest", 400)
}

func (o *UpdateRepository35BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository35Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/proxy/{repositoryName}][%d] updateRepository35Unauthorized", 401)
}
...
func (o *UpdateRepository35Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/proxy/{repositoryName}][%d] updateRepository35Forbidden", 403)
}
