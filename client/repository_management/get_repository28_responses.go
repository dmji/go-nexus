...
func (o *GetRepository28Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/npm/hosted/{repositoryName}] getRepository_28", response, response.Code())
	}
}
...
func (o *GetRepository28OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/npm/hosted/{repositoryName}][%d] getRepository28OK %s", 200, payload)
}
