...
func (o *UpdateRepository10Params) WithBody(body *models.CargoProxyRepositoryAPIRequest) *UpdateRepository10Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 10 params
func (o *UpdateRepository10Params) SetBody(body *models.CargoProxyRepositoryAPIRequest) {
	o.Body = body
}
