...
func (o *UpdateRepository27Params) WithBody(body *models.NpmHostedRepositoryAPIRequest) *UpdateRepository27Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 27 params
func (o *UpdateRepository27Params) SetBody(body *models.NpmHostedRepositoryAPIRequest) {
	o.Body = body
}
