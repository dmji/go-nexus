...
func (o *UpdateRepository31Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository31BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/nuget/proxy/{repositoryName}] updateRepository_31", response, response.Code())
	}
}
...
func (o *UpdateRepository31NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/nuget/proxy/{repositoryName}][%d] updateRepository31NoContent", 204)
}
...
// NewUpdateRepository31BadRequest creates a UpdateRepository31BadRequest with default headers values
func NewUpdateRepository31BadRequest() *UpdateRepository31BadRequest {
	return &UpdateRepository31BadRequest{}
}

/*
UpdateRepository31BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository31BadRequest struct {
}

// IsSuccess returns true when this update repository31 bad request response has a 2xx status code
func (o *UpdateRepository31BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository31 bad request response has a 3xx status code
func (o *UpdateRepository31BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository31 bad request response has a 4xx status code
func (o *UpdateRepository31BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository31 bad request response has a 5xx status code
func (o *UpdateRepository31BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository31 bad request response a status code equal to that given
func (o *UpdateRepository31BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository31 bad request response
func (o *UpdateRepository31BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository31BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/nuget/proxy/{repositoryName}][%d] updateRepository31BadRequest", 400)
}

func (o *UpdateRepository31BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/nuget/proxy/{repositoryName}][%d] updateRepository31BadRequest", 400)
}

func (o *UpdateRepository31BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository31Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/nuget/proxy/{repositoryName}][%d] updateRepository31Unauthorized", 401)
}
...
func (o *UpdateRepository31Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/nuget/proxy/{repositoryName}][%d] updateRepository31Forbidden", 403)
}
