...
func (o *CreateRepository33Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/pypi/group] createRepository_33", response, response.Code())
	}
}
...
func (o *CreateRepository33Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/group][%d] createRepository33Created", 201)
}
...
func (o *CreateRepository33Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/group][%d] createRepository33Unauthorized", 401)
}
...
func (o *CreateRepository33Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/pypi/group][%d] createRepository33Forbidden", 403)
}
