...
func (o *CreateRepository14Params) WithBody(body *models.ConanHostedRepositoryAPIRequest) *CreateRepository14Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 14 params
func (o *CreateRepository14Params) SetBody(body *models.ConanHostedRepositoryAPIRequest) {
	o.Body = body
}
