...
func (o *UpdateRepository14Params) WithBody(body *models.ConanHostedRepositoryAPIRequest) *UpdateRepository14Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 14 params
func (o *UpdateRepository14Params) SetBody(body *models.ConanHostedRepositoryAPIRequest) {
	o.Body = body
}
