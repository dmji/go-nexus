...
func (o *UpdateRepository25Params) WithBody(body *models.HuggingFaceProxyRepositoryAPIRequest) *UpdateRepository25Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 25 params
func (o *UpdateRepository25Params) SetBody(body *models.HuggingFaceProxyRepositoryAPIRequest) {
	o.Body = body
}
