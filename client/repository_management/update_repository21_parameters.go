...
func (o *UpdateRepository21Params) WithBody(body *models.GolangGroupRepositoryAPIRequest) *UpdateRepository21Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 21 params
func (o *UpdateRepository21Params) SetBody(body *models.GolangGroupRepositoryAPIRequest) {
	o.Body = body
}
