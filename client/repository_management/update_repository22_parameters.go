...
func (o *UpdateRepository22Params) WithBody(body *models.GolangProxyRepositoryAPIRequest) *UpdateRepository22Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 22 params
func (o *UpdateRepository22Params) SetBody(body *models.GolangProxyRepositoryAPIRequest) {
	o.Body = body
}
