...
func (o *CreateRepositoryParams) WithBody(body *models.AptHostedRepositoryAPIRequest) *CreateRepositoryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository params
func (o *CreateRepositoryParams) SetBody(body *models.AptHostedRepositoryAPIRequest) {
	o.Body = body
}
