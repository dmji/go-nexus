...
func (o *GetRepository18Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/docker/group/{repositoryName}] getRepository_18", response, response.Code())
	}
}
...
func (o *GetRepository18OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/docker/group/{repositoryName}][%d] getRepository18OK %s", 200, payload)
}
