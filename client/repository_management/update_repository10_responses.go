...
func (o *UpdateRepository10Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository10BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/cargo/proxy/{repositoryName}] updateRepository_10", response, response.Code())
	}
}
...
func (o *UpdateRepository10NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/proxy/{repositoryName}][%d] updateRepository10NoContent", 204)
}
...
// NewUpdateRepository10BadRequest creates a UpdateRepository10BadRequest with default headers values
func NewUpdateRepository10BadRequest() *UpdateRepository10BadRequest {
	return &UpdateRepository10BadRequest{}
}

/*
UpdateRepository10BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository10BadRequest struct {
}

// IsSuccess returns true when this update repository10 bad request response has a 2xx status code
func (o *UpdateRepository10BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository10 bad request response has a 3xx status code
func (o *UpdateRepository10BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository10 bad request response has a 4xx status code
func (o *UpdateRepository10BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository10 bad request response has a 5xx status code
func (o *UpdateRepository10BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository10 bad request response a status code equal to that given
func (o *UpdateRepository10BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository10 bad request response
func (o *UpdateRepository10BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository10BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/proxy/{repositoryName}][%d] updateRepository10BadRequest", 400)
}

func (o *UpdateRepository10BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/proxy/{repositoryName}][%d] updateRepository10BadRequest", 400)
}

func (o *UpdateRepository10BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository10Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/proxy/{repositoryName}][%d] updateRepository10Unauthorized", 401)
}
...
func (o *UpdateRepository10Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/proxy/{repositoryName}][%d] updateRepository10Forbidden", 403)
}
