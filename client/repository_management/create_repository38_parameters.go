...
func (o *CreateRepository38Params) WithBody(body *models.RProxyRepositoryAPIRequest) *CreateRepository38Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 38 params
func (o *CreateRepository38Params) SetBody(body *models.RProxyRepositoryAPIRequest) {
	o.Body = body
}
