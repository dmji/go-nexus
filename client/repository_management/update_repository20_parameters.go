...
func (o *UpdateRepository20Params) WithBody(body *models.GitLfsHostedRepositoryAPIRequest) *UpdateRepository20Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 20 params
func (o *UpdateRepository20Params) SetBody(body *models.GitLfsHostedRepositoryAPIRequest) {
	o.Body = body
}
