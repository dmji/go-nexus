...
func (o *CreateRepository9Params) WithBody(body *models.CargoHostedRepositoryAPIRequest) *CreateRepository9Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 9 params
func (o *CreateRepository9Params) SetBody(body *models.CargoHostedRepositoryAPIRequest) {
	o.Body = body
}
