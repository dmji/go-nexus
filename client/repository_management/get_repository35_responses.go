...
func (o *GetRepository35Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/pypi/hosted/{repositoryName}] getRepository_35", response, response.Code())
	}
}
...
func (o *GetRepository35OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/pypi/hosted/{repositoryName}][%d] getRepository35OK %s", 200, payload)
}
...
func (o *GetRepository35OK) GetPayload() *models.SimpleAPIHostedRepository {
	return o.Payload
}
