...
func (o *CreateRepository28Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/npm/proxy] createRepository_28", response, response.Code())
	}
}
...
func (o *CreateRepository28Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/proxy][%d] createRepository28Created", 201)
}
...
func (o *CreateRepository28Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/proxy][%d] createRepository28Unauthorized", 401)
}
...
func (o *CreateRepository28Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/proxy][%d] createRepository28Forbidden", 403)
}
