...
func (o *UpdateRepository16Params) WithBody(body *models.CondaProxyRepositoryAPIRequest) *UpdateRepository16Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 16 params
func (o *UpdateRepository16Params) SetBody(body *models.CondaProxyRepositoryAPIRequest) {
	o.Body = body
}
