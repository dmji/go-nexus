...
func (o *UpdateRepository8Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository8BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/cargo/group/{repositoryName}] updateRepository_8", response, response.Code())
	}
}
...
func (o *UpdateRepository8NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/group/{repositoryName}][%d] updateRepository8NoContent", 204)
}
...
// NewUpdateRepository8BadRequest creates a UpdateRepository8BadRequest with default headers values
func NewUpdateRepository8BadRequest() *UpdateRepository8BadRequest {
	return &UpdateRepository8BadRequest{}
}

/*
UpdateRepository8BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository8BadRequest struct {
}

// IsSuccess returns true when this update repository8 bad request response has a 2xx status code
func (o *UpdateRepository8BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository8 bad request response has a 3xx status code
func (o *UpdateRepository8BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository8 bad request response has a 4xx status code
func (o *UpdateRepository8BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository8 bad request response has a 5xx status code
func (o *UpdateRepository8BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository8 bad request response a status code equal to that given
func (o *UpdateRepository8BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository8 bad request response
func (o *UpdateRepository8BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository8BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/group/{repositoryName}][%d] updateRepository8BadRequest", 400)
}

func (o *UpdateRepository8BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/group/{repositoryName}][%d] updateRepository8BadRequest", 400)
}

func (o *UpdateRepository8BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository8Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/group/{repositoryName}][%d] updateRepository8Unauthorized", 401)
}
...
func (o *UpdateRepository8Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/cargo/group/{repositoryName}][%d] updateRepository8Forbidden", 403)
}
