...
func (o *GetRepository6Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/raw/group/{repositoryName}] getRepository_6", response, response.Code())
	}
}
...
func (o *GetRepository6OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/raw/group/{repositoryName}][%d] getRepository6OK %s", 200, payload)
}
