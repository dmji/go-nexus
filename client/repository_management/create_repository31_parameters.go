...
func (o *CreateRepository31Params) WithBody(body *models.NugetProxyRepositoryAPIRequest) *CreateRepository31Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 31 params
func (o *CreateRepository31Params) SetBody(body *models.NugetProxyRepositoryAPIRequest) {
	o.Body = body
}
