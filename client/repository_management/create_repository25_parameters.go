...
func (o *CreateRepository25Params) WithBody(body *models.HuggingFaceProxyRepositoryAPIRequest) *CreateRepository25Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 25 params
func (o *CreateRepository25Params) SetBody(body *models.HuggingFaceProxyRepositoryAPIRequest) {
	o.Body = body
}
