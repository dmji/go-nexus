...
func (o *UpdateRepository37Params) WithBody(body *models.RHostedRepositoryAPIRequest) *UpdateRepository37Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 37 params
func (o *UpdateRepository37Params) SetBody(body *models.RHostedRepositoryAPIRequest) {
	o.Body = body
}
