...
func (o *UpdateRepository13Params) WithBody(body *models.ConanGroupRepositoryAPIRequest) *UpdateRepository13Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 13 params
func (o *UpdateRepository13Params) SetBody(body *models.ConanGroupRepositoryAPIRequest) {
	o.Body = body
}
