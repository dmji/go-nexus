...
func (o *UpdateRepository35Params) WithBody(body *models.PypiProxyRepositoryAPIRequest) *UpdateRepository35Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 35 params
func (o *UpdateRepository35Params) SetBody(body *models.PypiProxyRepositoryAPIRequest) {
	o.Body = body
}
