...
func (o *UpdateRepository1Params) WithBody(body *models.AptProxyRepositoryAPIRequest) *UpdateRepository1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 1 params
func (o *UpdateRepository1Params) SetBody(body *models.AptProxyRepositoryAPIRequest) {
	o.Body = body
}
