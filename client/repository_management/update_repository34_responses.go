...
func (o *UpdateRepository34Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUpdateRepository34BadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/repositories/pypi/hosted/{repositoryName}] updateRepository_34", response, response.Code())
	}
}
...
func (o *UpdateRepository34NoContent) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/hosted/{repositoryName}][%d] updateRepository34NoContent", 204)
}
...
// NewUpdateRepository34BadRequest creates a UpdateRepository34BadRequest with default headers values
func NewUpdateRepository34BadRequest() *UpdateRepository34BadRequest {
	return &UpdateRepository34BadRequest{}
}

/*
UpdateRepository34BadRequest describes a response with status code 400, with default header values.

Bad request
*/
type UpdateRepository34BadRequest struct {
}

// IsSuccess returns true when this update repository34 bad request response has a 2xx status code
func (o *UpdateRepository34BadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update repository34 bad request response has a 3xx status code
func (o *UpdateRepository34BadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update repository34 bad request response has a 4xx status code
func (o *UpdateRepository34BadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this update repository34 bad request response has a 5xx status code
func (o *UpdateRepository34BadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this update repository34 bad request response a status code equal to that given
func (o *UpdateRepository34BadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the update repository34 bad request response
func (o *UpdateRepository34BadRequest) Code() int {
	return 400
}

func (o *UpdateRepository34BadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/hosted/{repositoryName}][%d] updateRepository34BadRequest", 400)
}

func (o *UpdateRepository34BadRequest) String() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/hosted/{repositoryName}][%d] updateRepository34BadRequest", 400)
}

func (o *UpdateRepository34BadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateRepository34Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/hosted/{repositoryName}][%d] updateRepository34Unauthorized", 401)
}
...
func (o *UpdateRepository34Forbidden) Error() string {
	return fmt.Sprintf("[PUT /v1/repositories/pypi/hosted/{repositoryName}][%d] updateRepository34Forbidden", 403)
}
