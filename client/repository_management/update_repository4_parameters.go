...
func (o *UpdateRepository4Params) WithBody(body *models.MavenProxyRepositoryAPIRequest) *UpdateRepository4Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 4 params
func (o *UpdateRepository4Params) SetBody(body *models.MavenProxyRepositoryAPIRequest) {
	o.Body = body
}
