...
func (o *UpdateRepository2Params) WithBody(body *models.MavenGroupRepositoryAPIRequest) *UpdateRepository2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 2 params
func (o *UpdateRepository2Params) SetBody(body *models.MavenGroupRepositoryAPIRequest) {
	o.Body = body
}
