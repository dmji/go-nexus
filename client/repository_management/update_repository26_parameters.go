...
func (o *UpdateRepository26Params) WithBody(body *models.NpmGroupRepositoryAPIRequest) *UpdateRepository26Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 26 params
func (o *UpdateRepository26Params) SetBody(body *models.NpmGroupRepositoryAPIRequest) {
	o.Body = body
}
