...
func (o *CreateRepository35Params) WithBody(body *models.PypiProxyRepositoryAPIRequest) *CreateRepository35Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 35 params
func (o *CreateRepository35Params) SetBody(body *models.PypiProxyRepositoryAPIRequest) {
	o.Body = body
}
