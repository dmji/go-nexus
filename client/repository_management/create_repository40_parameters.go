...
func (o *CreateRepository40Params) WithBody(body *models.RubyGemsHostedRepositoryAPIRequest) *CreateRepository40Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 40 params
func (o *CreateRepository40Params) SetBody(body *models.RubyGemsHostedRepositoryAPIRequest) {
	o.Body = body
}
