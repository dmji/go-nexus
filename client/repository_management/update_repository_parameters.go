...
func (o *UpdateRepositoryParams) WithBody(body *models.AptHostedRepositoryAPIRequest) *UpdateRepositoryParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository params
func (o *UpdateRepositoryParams) SetBody(body *models.AptHostedRepositoryAPIRequest) {
	o.Body = body
}
