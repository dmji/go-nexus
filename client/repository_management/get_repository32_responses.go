...
func (o *GetRepository32Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/nuget/proxy/{repositoryName}] getRepository_32", response, response.Code())
	}
}
...
func (o *GetRepository32OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/nuget/proxy/{repositoryName}][%d] getRepository32OK %s", 200, payload)
}
...
func (o *GetRepository32OK) GetPayload() *models.NugetProxyAPIRepository {
	return o.Payload
}
