...
func (o *UpdateRepository32Params) WithBody(body *models.P2ProxyRepositoryAPIRequest) *UpdateRepository32Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 32 params
func (o *UpdateRepository32Params) SetBody(body *models.P2ProxyRepositoryAPIRequest) {
	o.Body = body
}
