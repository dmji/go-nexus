...
func (o *UpdateRepository40Params) WithBody(body *models.RubyGemsHostedRepositoryAPIRequest) *UpdateRepository40Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update repository 40 params
func (o *UpdateRepository40Params) SetBody(body *models.RubyGemsHostedRepositoryAPIRequest) {
	o.Body = body
}
