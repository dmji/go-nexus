...
func (o *CreateRepository10Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/cargo/proxy] createRepository_10", response, response.Code())
	}
}
...
func (o *CreateRepository10Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/cargo/proxy][%d] createRepository10Created", 201)
}
...
func (o *CreateRepository10Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/cargo/proxy][%d] createRepository10Unauthorized", 401)
}
...
func (o *CreateRepository10Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/cargo/proxy][%d] createRepository10Forbidden", 403)
}
