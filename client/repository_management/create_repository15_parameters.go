...
func (o *CreateRepository15Params) WithBody(body *models.ConanProxyRepositoryAPIRequest) *CreateRepository15Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 15 params
func (o *CreateRepository15Params) SetBody(body *models.ConanProxyRepositoryAPIRequest) {
	o.Body = body
}
