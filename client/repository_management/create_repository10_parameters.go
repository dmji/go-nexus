...
func (o *CreateRepository10Params) WithBody(body *models.CargoProxyRepositoryAPIRequest) *CreateRepository10Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 10 params
func (o *CreateRepository10Params) SetBody(body *models.CargoProxyRepositoryAPIRequest) {
	o.Body = body
}
