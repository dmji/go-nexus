...
func (o *GetRepository25Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/helm/proxy/{repositoryName}] getRepository_25", response, response.Code())
	}
}
...
func (o *GetRepository25OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/helm/proxy/{repositoryName}][%d] getRepository25OK %s", 200, payload)
}
