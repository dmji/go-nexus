...
func (o *CreateRepository1Params) WithBody(body *models.AptProxyRepositoryAPIRequest) *CreateRepository1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 1 params
func (o *CreateRepository1Params) SetBody(body *models.AptProxyRepositoryAPIRequest) {
	o.Body = body
}
