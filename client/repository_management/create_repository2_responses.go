...
func (o *CreateRepository2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/maven/group] createRepository_2", response, response.Code())
	}
}
...
func (o *CreateRepository2Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/maven/group][%d] createRepository2Created", 201)
}
...
func (o *CreateRepository2Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/maven/group][%d] createRepository2Unauthorized", 401)
}
...
func (o *CreateRepository2Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/maven/group][%d] createRepository2Forbidden", 403)
}
