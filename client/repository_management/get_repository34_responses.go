...
func (o *GetRepository34Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/pypi/group/{repositoryName}] getRepository_34", response, response.Code())
	}
}
...
func (o *GetRepository34OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/pypi/group/{repositoryName}][%d] getRepository34OK %s", 200, payload)
}
...
func (o *GetRepository34OK) GetPayload() *models.SimpleAPIGroupRepository {
	return o.Payload
}
