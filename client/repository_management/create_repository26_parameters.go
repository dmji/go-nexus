...
func (o *CreateRepository26Params) WithBody(body *models.NpmGroupRepositoryAPIRequest) *CreateRepository26Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 26 params
func (o *CreateRepository26Params) SetBody(body *models.NpmGroupRepositoryAPIRequest) {
	o.Body = body
}
