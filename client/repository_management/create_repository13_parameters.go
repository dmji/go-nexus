...
func (o *CreateRepository13Params) WithBody(body *models.ConanGroupRepositoryAPIRequest) *CreateRepository13Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create repository 13 params
func (o *CreateRepository13Params) SetBody(body *models.ConanGroupRepositoryAPIRequest) {
	o.Body = body
}
