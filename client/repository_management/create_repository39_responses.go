...
func (o *CreateRepository39Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/rubygems/group] createRepository_39", response, response.Code())
	}
}
...
func (o *CreateRepository39Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/group][%d] createRepository39Created", 201)
}
...
func (o *CreateRepository39Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/group][%d] createRepository39Unauthorized", 401)
}
...
func (o *CreateRepository39Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/rubygems/group][%d] createRepository39Forbidden", 403)
}
