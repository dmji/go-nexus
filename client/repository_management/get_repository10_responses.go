...
func (o *GetRepository10Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/repositories/cargo/hosted/{repositoryName}] getRepository_10", response, response.Code())
	}
}
...
func (o *GetRepository10OK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/repositories/cargo/hosted/{repositoryName}][%d] getRepository10OK %s", 200, payload)
}
