...
func (o *CreateRepository38Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	case 405:
		result := NewCreateRepository38MethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/r/proxy] createRepository_38", response, response.Code())
	}
}
...
func (o *CreateRepository38Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/proxy][%d] createRepository38Created", 201)
}
...
func (o *CreateRepository38Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/proxy][%d] createRepository38Unauthorized", 401)
}
...
func (o *CreateRepository38Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/proxy][%d] createRepository38Forbidden", 403)
}
...
// NewCreateRepository38MethodNotAllowed creates a CreateRepository38MethodNotAllowed with default headers values
func NewCreateRepository38MethodNotAllowed() *CreateRepository38MethodNotAllowed {
	return &CreateRepository38MethodNotAllowed{}
}

/*
CreateRepository38MethodNotAllowed describes a response with status code 405, with default header values.

Feature is disabled in High Availability
*/
type CreateRepository38MethodNotAllowed struct {
}

// IsSuccess returns true when this create repository38 method not allowed response has a 2xx status code
func (o *CreateRepository38MethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create repository38 method not allowed response has a 3xx status code
func (o *CreateRepository38MethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create repository38 method not allowed response has a 4xx status code
func (o *CreateRepository38MethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this create repository38 method not allowed response has a 5xx status code
func (o *CreateRepository38MethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this create repository38 method not allowed response a status code equal to that given
func (o *CreateRepository38MethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the create repository38 method not allowed response
func (o *CreateRepository38MethodNotAllowed) Code() int {
	return 405
}

func (o *CreateRepository38MethodNotAllowed) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/r/proxy][%d] createRepository38MethodNotAllowed", 405)
}

func (o *CreateRepository38MethodNotAllowed) String() string {
	return fmt.Sprintf("[POST /v1/repositories/r/proxy][%d] createRepository38MethodNotAllowed", 405)
}

func (o *CreateRepository38MethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
