...
func (o *CreateRepository27Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/repositories/npm/hosted] createRepository_27", response, response.Code())
	}
}
...
func (o *CreateRepository27Created) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/hosted][%d] createRepository27Created", 201)
}
...
func (o *CreateRepository27Unauthorized) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/hosted][%d] createRepository27Unauthorized", 401)
}
...
func (o *CreateRepository27Forbidden) Error() string {
	return fmt.Sprintf("[POST /v1/repositories/npm/hosted][%d] createRepository27Forbidden", 403)
}
