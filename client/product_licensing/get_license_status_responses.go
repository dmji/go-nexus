...
func (o *GetLicenseStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/system/license] getLicenseStatus", response, response.Code())
	}
}
...
func (o *GetLicenseStatusOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/system/license][%d] getLicenseStatusOK %s", 200, payload)
}
