...
// WithRealm adds the realm to the delete user params
func (o *DeleteUserParams) WithRealm(realm *string) *DeleteUserParams {
	o.SetRealm(realm)
	return o
}

// SetRealm adds the realm to the delete user params
func (o *DeleteUserParams) SetRealm(realm *string) {
	o.Realm = realm
}
