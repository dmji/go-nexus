...
func (o *GetUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/security/users] getUsers", response, response.Code())
	}
}
...
func (o *GetUsersOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/security/users][%d] getUsersOK %s", 200, payload)
}
