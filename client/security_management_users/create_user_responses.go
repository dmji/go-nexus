...
func (o *CreateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/security/users] createUser", response, response.Code())
	}
}
...
func (o *CreateUserOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/security/users][%d] createUserOK %s", 200, payload)
}
