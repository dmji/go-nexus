...
func (o *GetRealmsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/security/realms/available] getRealms", response, response.Code())
	}
}
...
func (o *GetRealmsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/security/realms/available][%d] getRealmsOK %s", 200, payload)
}
