...
func (o *UpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /v1/security/anonymous] update", response, response.Code())
	}
}
...
func (o *UpdateOK) Error() string {
	...
	return fmt.Sprintf("[PUT /v1/security/anonymous][%d] updateOK %s", 200, payload)
}
