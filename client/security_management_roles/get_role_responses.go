...
func (o *GetRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/security/roles/{id}] getRole", response, response.Code())
	}
}
...
func (o *GetRoleOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/security/roles/{id}][%d] getRoleOK %s", 200, payload)
}
